...
import com.mokaform.mokaformserver.common.config.MailConfig;
...
public class EmailService {
    ...
    private MimeMessage createMessage(String subject, String to) throws MessagingException, UnsupportedEncodingException {
        ...
        String msg = new StringBuilder()
                .append("<h1 style=\"font-size: 30px; padding-right: 30px; padding-left: 30px;\">이메일 주소 확인</h1>")
                .append("<p style=\\\"font-size: 17px; padding-right: 30px; padding-left: 30px;\\\">아래 확인 코드를 회원가입 화면에서 입력해주세요.</p>\"")
